...
import hope_documents
from hope_documents.config import env
...
class Command(BaseCommand):
    ...
    def handle(self, *args: Any, **options: Any) -> None:  # noqa: C901
        from hope_documents.models import User  # noqa: PLC0415
        ...
        try:
            ...
            echo(f"Running upgrade of version {hope_documents.VERSION}", style_func=self.style.WARNING)
